...
const ResetPassword: React.FC = () => {
        ...
        if(oobCode){
            ...
            .catch(error => {
                ...
                const ERRORS = [
                    ...
                    ["auth/expired-action-code", "action code expired, please request to change password again"],
                ...
                const ERROR_CODES = ERRORS.map(item => item[0]);
                 ...
                 if(ERROR_CODES.includes(errorCode)){
                     ...
                     setPasswordErrors(passwordErrors => [...passwordErrors, error_message]);
                 }
            })
      }
    }
    ...
    return (
        ...
        <LogoContainer>
         ...
         <ResetForm>
             <PasswordContainer>
             <InputBox type={eyeIcon ? "password" : "text"} placeholder="New Password" name="password" onChange={handleChange}></InputBox>
                {
                    eyeIcon ? 
         ...
         {
             <ErrorList> {
                passwordErrors && passwordErrors.map((error, item) => {
                    return (
